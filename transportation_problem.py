...
Original file is located at
    https://colab.research.google.com/drive/1h9C0_rF5xolaCpSgc6yLYp7i_r_GPpYc
...
def transportation_simplex_method(supply, demand, costs):
    ...
    solution = np.zeros((len(balanced_costs), len(balanced_costs[0])), dtype=int)
